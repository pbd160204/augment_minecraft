...
function augment:augment/grant_random_advanced_wizard
tellraw @s [{"text":"[Augment] ","color":"gold"},{"text":"연금술 III 획득 - 무작위 고급 증강을 한 개 획득합니다. 마법사 계열 고급 증강을 획득할 확률이 높습니다. (50%)","color":"aqua"}]
