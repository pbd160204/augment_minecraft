...
execute if score @s ag_aug1 matches 1.. run tellraw @s {"text":"[생존] 옴의 법칙","color":"gold","hover_event":{"action":"show_text","value":"영구적인 화염 저항과 저항 I 효과를 획득합니다."}}
execute if score @s ag_aug2 matches 1.. run tellraw @s {"text":"[생존] 질량 결손","color":"gold","hover_event":{"action":"show_text","value":"점프 높이가 2칸으로 변경되며 낙하 피해를 받지 않습니다."}}
execute if score @s ag_aug3 matches 1.. run tellraw @s {"text":"[생존] 혜성","color":"gold","hover_event":{"action":"show_text","value":"영구적인 신속 I를 얻는 대신 발광합니다."}}
execute if score @s ag_aug4 matches 1.. run tellraw @s {"text":"[생존] 체력은 국력","color":"gold","hover_event":{"action":"show_text","value":"최대 체력이 10 증가합니다."}}
execute if score @s ag_aug5 matches 1.. run tellraw @s {"text":"[생존] 줄타기","color":"gold","hover_event":{"action":"show_text","value":"거미줄 이동 저항을 제거하고 거미줄 64개를 획득합니다."}}
...
execute if score @s ag_aug15 matches 1.. run tellraw @s {"text":"[퀘스트] 분탕","color":"dark_red","hover_event":{"action":"show_text","value":"파밍 시간에 다른 플레이어를 공격할 수 있습니다. 힘 I·허기 I·색 발광을 얻고 첫 플레이어 처치 시 저항 II를 획득합니다."}}
...
execute if score @s ag_aug19 matches 1.. run tellraw @s {"text":"[마법사] 전투 메이지","color":"light_purple","hover_event":{"action":"show_text","value":"돌풍구와 화염구를 획득합니다."}}
...
execute if score @s ag_aug25 matches 1.. run tellraw @s {"text":"[채굴] 성급함","color":"blue","hover_event":{"action":"show_text","value":"영구적인 성급함 II 효과를 획득합니다."}}
execute if score @s ag_aug26 matches 1.. run tellraw @s {"text":"[채굴] 가공 전문가","color":"blue","hover_event":{"action":"show_text","value":"행운 II가 부여된 다이아몬드 곡괭이를 획득합니다."}}
execute if score @s ag_aug27 matches 1.. run tellraw @s {"text":"[채굴] 돌도 씹어 먹을 나이","color":"blue","hover_event":{"action":"show_text","value":"Y좌표가 0 이하일 때 지속적으로 포화 효과를 획득합니다."}}
execute if score @s ag_aaug1 matches 1.. run tellraw @s {"text":"[고급] 원코","color":"light_purple","hover_event":{"action":"show_text","value":"PvP 단계 사망 시 1회 인벤토리를 유지한 채 즉시 부활하며 최대 체력 10, 15초 투명화와 10초 신속 I을 얻고 무작위 위치로 이동합니다."}}
execute if score @s ag_aaug2 matches 1.. run tellraw @s {"text":"[고급] 박사 과정","color":"light_purple","hover_event":{"action":"show_text","value":"모든 경험치를 60% 더 많이 획득하지만 허기 I 효과를 받습니다."}}
execute if score @s ag_aaug3 matches 1.. run tellraw @s {"text":"[고급] 폭탄 받아라","color":"light_purple","hover_event":{"action":"show_text","value":"폭발 보호 IV 다이아몬드 흉갑과 0.3초 후 폭발하는 폭발 장약 10개를 획득합니다."}}
execute if score @s ag_aaug4 matches 1.. run tellraw @s {"text":"[고급] 탑베인","color":"light_purple","hover_event":{"action":"show_text","value":"힘 III와 무한이 부여된 활과 화살을 획득합니다."}}
execute if score @s ag_aaug5 matches 1.. run tellraw @s {"text":"[고급] 조준경 부착","color":"light_purple","hover_event":{"action":"show_text","value":"근접 공격 사거리가 1칸 증가합니다."}}
...
execute if score @s ag_aaug7 matches 1.. run tellraw @s {"text":"[고급] 성급함 IV","color":"light_purple","hover_event":{"action":"show_text","value":"상점에서 다이아몬드 16개로 심층암 파쇄기를 구매할 수 있습니다."}}
execute if score @s ag_aug29 matches 1.. run tellraw @s {"text":"[퀘스트] 여행자","color":"aqua","hover_event":{"action":"show_text","value":"파밍 시간에 월드보더 네 모서리의 10블록 이내에 모두 도달하세요. 진행도는 액션바에 표시되며, 완료 시 경험치 2000과 여행자의 신발을 획득합니다."}}
