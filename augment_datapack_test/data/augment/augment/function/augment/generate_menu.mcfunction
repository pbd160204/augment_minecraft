...
execute if score @s ag_owned matches ..23 run function augment:augment/roll_c1
execute if score @s ag_owned matches ..23 run function augment:augment/roll_c2
execute if score @s ag_owned matches ..23 run function augment:augment/roll_c3
...
execute if score @s ag_owned matches 24 run scoreboard players set @s ag_c3 0
execute if score @s ag_owned matches 25 run function augment:augment/roll_c1
execute if score @s ag_owned matches 25 run scoreboard players set @s ag_c2 0
