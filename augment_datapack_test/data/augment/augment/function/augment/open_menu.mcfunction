...
execute if score @s ag_owned matches 28.. run tellraw @s [{"text":"[Augment] ","color":"gold"},{"text":"일반 증강을 모두 보유 중입니다.","color":"yellow"}]
execute if score @s ag_owned matches 28.. run return fail
