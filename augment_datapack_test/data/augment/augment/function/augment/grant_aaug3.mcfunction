...
give @s minecraft:tnt[minecraft:custom_name={text:"폭발 장약",color:"red",italic:false},minecraft:lore=[{text:"고체 블록 면에 설치하면 0.3초 후 폭발",color:"gray",italic:false}],minecraft:custom_data={augment:{bomb_charge:1b}}] 10
