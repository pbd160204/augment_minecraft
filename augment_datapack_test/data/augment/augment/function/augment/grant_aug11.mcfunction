...
give @s minecraft:stone_sword[minecraft:attribute_modifiers=[{type:"minecraft:attack_damage",id:"augment:iron_sword_damage",amount:5.0,operation:"add_value",slot:"mainhand"},{type:"minecraft:attack_speed",id:"augment:iron_sword_speed",amount:50.0,operation:"add_value",slot:"mainhand"}]] 1
