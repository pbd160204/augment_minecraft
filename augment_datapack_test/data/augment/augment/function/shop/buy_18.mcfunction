...
scoreboard players set #price ag_math 64
execute if score @s ag_catmine matches 3.. run scoreboard players set #price ag_math 45
function augment:shop/charge
execute if score #paid ag_math matches 1 run give @s minecraft:mace
