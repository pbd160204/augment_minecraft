...
execute if score @s ag_bgrow matches 4 run scoreboard players add @s ag_points 1
execute if score @s ag_bgrow matches 4 run tellraw @s [{"text":"[계열 보너스] ","color":"gold"},{"text":"성장 4 달성 - 일반 증강 선택권 1개를 획득했습니다.","color":"aqua"}]
