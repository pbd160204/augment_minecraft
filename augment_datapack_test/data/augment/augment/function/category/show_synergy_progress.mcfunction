...
execute if score @s ag_catsurv matches 5.. run scoreboard players set @s ag_nsurv 6
scoreboard players set @s ag_ngrow 4
execute if score @s ag_catgrow matches 4.. run scoreboard players set @s ag_ngrow 5
scoreboard players set @s ag_ncomb 3
execute if score @s ag_catcomb matches 3.. run scoreboard players set @s ag_ncomb 4
...
execute if score @s ag_catwiz matches 6.. run scoreboard players set @s ag_nwiz 9
