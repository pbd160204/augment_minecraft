...
execute if score #bprog ag_math matches ..299 run scoreboard players set #bcool ag_math 19
execute if score #bprog ag_math matches 300.. run function augment:game/finish_shrink
