...
execute as @a[scores={ag_alive=1,ag_points=1..}] if score @s ag_mwait matches 0 if score @s ag_menuopen matches 0 if score @s ag_owned matches ..30 run function augment:augment/generate_menu
