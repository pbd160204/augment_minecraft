...
execute if score @s ag_bsurv matches 7 run give @s totem_of_undying 1
execute if score @s ag_bsurv matches 7 run tellraw @s [{"text":"[계열 보너스] ","color":"gold"},{"text":"생존 7 달성 - 불사의 토템을 획득했습니다.","color":"aqua"}]
