...
execute if score @s ag_catcomb matches 4 run scoreboard players set @s ag_dmgbonus 3
execute if score @s ag_catcomb matches 5 run scoreboard players set @s ag_dmgbonus 4
execute if score @s ag_catcomb matches 6.. run scoreboard players set @s ag_dmgbonus 6
execute if score @s ag_bwiz matches 10.. run effect give @s strength 2 1 true
execute if score @s ag_bwiz matches 10.. run effect give @s regeneration 2 1 true
