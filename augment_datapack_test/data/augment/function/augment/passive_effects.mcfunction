...
execute if score @s ag_aug3 matches 1.. if score @s ag_contractdone matches 0 run effect give @s minecraft:glowing 5 0 true
...
execute if score #state ag_math matches 1..2 if score @s ag_aug32 matches 1.. run effect give @s minecraft:glowing 5 0 true
...
execute if score #state ag_math matches 1 if score @s ag_aug27 matches 1.. if score #tmp ag_math matches ..0 run effect give @s minecraft:saturation 5 0 true
...
execute if score #state ag_math matches 1 if score @s ag_aug15 matches 1.. if score @s ag_qdone matches 0 if score @s ag_contractdone matches 0 run effect give @s minecraft:glowing 5 0 true
