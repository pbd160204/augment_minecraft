...
execute unless score @s ag_aaug2 matches 1.. store result storage augment:runtime xp.amount int 12 if score #tmp ag_math matches 1.. run scoreboard players get #tmp ag_math
...
execute if score @s ag_aaug2 matches 1.. store result storage augment:runtime xp.amount int 19 if score #tmp ag_math matches 1.. run scoreboard players get #tmp ag_math
