...
execute if score #tmp ag_math matches 2 if score @s ag_aug1 matches ..0 run function augment:augment/grant_aug1_random
execute if score #tmp ag_math matches 2 if score @s ag_aug1 matches 1.. if score #aaug_selected ag_math matches ..0 run function augment:augment/grant_random_advanced_survival_other
