...
execute if score #paid ag_math matches 1 run give @s potion[potion_contents={custom_effects:[{id:"minecraft:invisibility",amplifier:0,duration:1200,show_particles:0b}]}]
