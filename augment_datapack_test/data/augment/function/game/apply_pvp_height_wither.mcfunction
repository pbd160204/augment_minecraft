...
execute if score #timer ag_math matches 18000.. if score #pvp_height ag_math matches 5501..14999 run effect clear @s minecraft:wither
...
execute if score #pvp_witherpulse ag_math matches 0 if score #timer ag_math matches 18000.. if score #pvp_height ag_math matches ..5500 run effect give @s minecraft:wither 3 0 true
