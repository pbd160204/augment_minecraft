...
scoreboard players operation #spread_range ag_math /= #eight ag_math
scoreboard players remove #spread_range ag_math 8
execute if score #spread_range ag_math matches ..0 run scoreboard players set #spread_range ag_math 0
