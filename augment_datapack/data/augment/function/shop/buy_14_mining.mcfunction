...
execute if score @s ag_catmine matches 5.. run scoreboard players set #price ag_math 160
function augment:shop/charge
execute if score #paid ag_math matches 1 run give @s minecraft:elytra
