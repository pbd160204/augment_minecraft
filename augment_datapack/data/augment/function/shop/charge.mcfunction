...
execute if score @s ag_farmshop matches 1.. if score @s ag_catmine matches 3.. run function augment:shop/apply_mining_discount
...
execute if score @s ag_aug40 matches 1.. run scoreboard players operation #price ag_math *= #three ag_math
execute if score @s ag_catmine matches 3.. run function augment:shop/apply_mining_discount
