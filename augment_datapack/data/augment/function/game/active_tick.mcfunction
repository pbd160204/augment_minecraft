...
execute as @a[scores={ag_alive=1,ag_points=1..}] if score @s ag_mwait matches 0 if score @s ag_menuopen matches 0 if score @s ag_owned matches ..36 run function augment:augment/generate_menu
...
execute as @a[scores={ag_alive=1,ag_advpts=1..}] if score @s ag_advwait matches 0 if score @s ag_advopen matches 0 if score @s ag_advowned matches ..7 run function augment:augment/generate_adv_menu
