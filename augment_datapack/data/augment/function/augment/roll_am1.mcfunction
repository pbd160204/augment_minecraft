...
execute if score @s ag_am1 matches 8 if score @s ag_aaug8 matches 1.. run function augment:augment/roll_am1
execute if score @s ag_am1 matches 9 if score @s ag_aaug9 matches 1.. run function augment:augment/roll_am1
