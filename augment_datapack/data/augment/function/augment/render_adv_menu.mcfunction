...
execute if score @s ag_am1 matches 10 run function augment:augment/render_am1_ohm
execute if score @s ag_am2 matches 1.. run function augment:augment/render_am2
execute if score @s ag_am2 matches 10 run function augment:augment/render_am2_ohm
execute if score @s ag_am3 matches 1.. run function augment:augment/render_am3
execute if score @s ag_am3 matches 10 run function augment:augment/render_am3_ohm
