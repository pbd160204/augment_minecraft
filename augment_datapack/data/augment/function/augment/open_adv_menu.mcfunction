function augment:augment/open_adv_menu_v2
return 1
...
execute if score @s ag_advowned matches 9.. run tellraw @s [{"text":"[Augment] ","color":"gold"},{"text":"고급 증강을 모두 보유 중입니다.","color":"yellow"}]
execute if score @s ag_advowned matches 9.. run return fail
